...
const steps = [
  {
    ...
    desc: 'Entendemos tu problema, tus sistemas actuales y el objetivo del proyecto. Sin compromiso.',
  },
  {
    num: '02',
    title: 'Propuesta técnica',
    desc: 'En 48hs te enviamos una propuesta detallada: arquitectura, tecnologías, plazo y presupuesto.',
  },
  {
    num: '03',
    title: 'Desarrollo iterativo',
    desc: 'Sprints de 2 semanas con demos frecuentes. Tú ves el progreso real desde el primer sprint.',
  },
  {
    num: '04',
    title: 'QA y lanzamiento',
    desc: 'Testing exhaustivo, review de performance y despliegue controlado en tu tienda o en el App Store.',
  },
  {
    num: '05',
    title: 'Soporte continuo',
    desc: 'Post-lanzamiento con soporte activo, monitoreo y mejoras incrementales según el feedback.',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">
            <WordsPullUp text="Un proceso claro, sin sorpresas" wordClassName="text-[#0F172A]" stagger={0.06} />
          </h2>
          <p className="text-[#4B5563] text-sm md:text-base">
            Desde la primera reunión hasta el lanzamiento, sabes exactamente qué esperar.
          </p>
        </div>
