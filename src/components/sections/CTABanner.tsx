    ...
    <section className="relative overflow-hidden py-28 md:py-36">
      ...
      <div ref={ref} className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-white/70 text-base leading-relaxed mb-10 max-w-xl mx-auto [&_strong]:font-semibold [&_strong]:text-white/90 [&_em]:italic" style={descStyle} dangerouslySetInnerHTML={{ __html: safeHtml(desc) }} />
