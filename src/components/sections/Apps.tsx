...
const apps = [
  {
    id: 'calendify',
    mockup: <CalendifyMockup />,
    badge: 'Publicada en Shopify App Store',
    badgeColor: '#10B981',
    title: 'Calendify Delivery',
    desc: 'App de gestión de entregas con selección de rangos horarios, notificaciones automáticas y panel de control para merchants. Más de 50 tiendas activas.',
    tags: ['Shopify', 'Remix', 'PostgreSQL', 'Vercel'],
    dir: -1,
  },
  {
    id: 'descuentify',
    mockup: <DescuentifyMockup />,
    badge: 'Publicada en Shopify App Store',
    badgeColor: '#10B981',
    title: 'Descuentify',
    desc: 'Motor de descuentos avanzado para Shopify con reglas complejas, descuentos por volumen, combos y campañas personalizadas. Aumenta el AOV de tu tienda.',
    tags: ['Shopify', 'Node.js', 'React', 'GraphQL'],
    dir: 1,
  },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">
            <WordsPullUp text="Apps que ya están resolviendo problemas reales" wordClassName="text-[#0F172A]" stagger={0.05} />
          </h2>
          <p className="text-[#4B5563] text-sm md:text-base max-w-xl mx-auto">
            Publicadas en el Shopify App Store, en producción, con merchants reales.
          </p>
        </div>
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {apps.map((app, i) => (
            ...
            >
              {/* Mock UI */}
              <div className="p-5 pb-2 bg-[#F8FAFF] border-b border-[#E5E7EB]">
                {app.mockup}
              </div>
              ...
              <div className="p-6">
                <span
                  ...
                  style={{ color: app.badgeColor, backgroundColor: `${app.badgeColor}15` }}
                >
                  <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: app.badgeColor }} />
                  {app.badge}
                </span>
