        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-4 space-y-6">
                ...
                {form.featured_image ? (
                  <div className="relative group rounded-lg overflow-hidden border border-slate-200">
                    ...
                    <div className="absolute inset-0 bg-slate-900/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                      <button type="button" onClick={() => featuredInputRef.current?.click()} className="bg-white px-3 py-1.5 rounded-lg text-xs font-medium shadow-md">Cambiar</button>
                      <button type="button" onClick={() => set('featured_image', '')} className="bg-white px-3 py-1.5 rounded-lg text-xs font-medium shadow-md text-red-600">Eliminar</button>
                    </div>
                  </div>
                ) : (
                  <button
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm space-y-4" style={{ border: '1px solid #CBD5E1' }}>
              ...
              <div className="pt-2">{publishToggle}</div>
            </div>
          </div>
        </div>
      </form>
...
export default function BlogEditorPage() {
  return <ProtectedRoute><BlogEditorContent /></ProtectedRoute>
}
