      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden" style={{ border: '1px solid #CBD5E1' }}>
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-3 py-20 text-slate-400">
            ...
            <button onClick={() => router.push('/admin/blog/new')} className="text-adm-primary text-sm font-medium hover:underline">Crear el primero →</button>
          </div>
        ) : (
          <>
                    ...
                    <tr key={post.id} className="hover:bg-slate-50 transition-colors group">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <Link href={`/admin/blog/${post.id}`} className="text-[14px] font-medium text-slate-900 hover:text-adm-primary transition-colors line-clamp-2">
                            {post.title}
                          </Link>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <Link href={`/admin/blog/${post.id}`} className="p-2 text-slate-400 hover:text-adm-primary transition-colors">
