...
function SettingsContent() {
  ...
  const currentEmail = typeof window !== 'undefined' ? localStorage.getItem('admin_email') || '' : ''
          ...
          <form onSubmit={handleSeoSave} className="p-6 flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                style={inputStyle}
              />
              <p className="text-[11px] text-slate-400">Recomendado: 60 caracteres. Actual: {seoForm.meta_title.length}</p>
            </div>
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                style={inputStyle}
              />
              <p className="text-[11px] text-slate-400">Recomendado: 160 caracteres. Actual: {seoForm.meta_description.length}</p>
            </div>
