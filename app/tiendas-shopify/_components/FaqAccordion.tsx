...
// indexan igual aunque estén cerradas. Estilo para fondo oscuro.
          ...
          <div key={f.q} className="border-b border-white/10">
            <h3 className="m-0">
              <button
                ...
                className="flex w-full items-center justify-between gap-5 py-6 text-left text-base font-semibold text-primary transition-colors duration-200 hover:text-accent md:text-lg"
              >
                {f.q}
                <span
            ...
            >
              <div className="min-h-0 overflow-hidden">
                <p className="m-0 max-w-[62ch] pb-6 text-base leading-[1.7] text-[#7B8DB0]">{f.a}</p>
              </div>
            </div>
          </div>
        )
